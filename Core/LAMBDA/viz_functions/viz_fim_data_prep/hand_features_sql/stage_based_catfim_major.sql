SELECT
    ...
    crosswalk.hydro_id,
	ROUND(CAST(rf.adj_major_stage_m as numeric), 2) AS stage_m,
    rf.nws_station_id
...
LEFT OUTER JOIN ingest.stage_based_catfim_major AS fim ON rf.trace_feature_id = fim.feature_id AND rf.nws_station_id = fim.nws_station_id
