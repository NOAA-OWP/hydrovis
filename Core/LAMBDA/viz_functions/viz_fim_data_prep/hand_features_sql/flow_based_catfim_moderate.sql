SELECT
    ...
    crosswalk.hydro_id,
	ROUND(CAST(rf.moderate_flow_cms as numeric), 2) AS streamflow_cms,
    rf.nws_station_id
...
LEFT OUTER JOIN ingest.flow_based_catfim_moderate AS fim ON rf.trace_feature_id = fim.feature_id AND rf.nws_station_id = fim.nws_station_id
