DROP TABLE IF EXISTS ingest.stage_based_catfim_action_intervals;
WITH main AS (
	SELECT
...
INTO ingest.stage_based_catfim_action_intervals
...
DROP TABLE IF EXISTS ingest.stage_based_catfim_action_intervals_job_num;
SELECT *
INTO ingest.stage_based_catfim_action_intervals_job_num
FROM ingest.stage_based_catfim_action_intervals
WHERE interval_ft > lower_interval AND interval_ft <= upper_interval;

----------------------------------------------------------------------------------------------------------
SELECT UpdateGeometrySRID('ingest', 'stage_based_catfim_action_intervals', 'geom', 3857);
SELECT UpdateGeometrySRID('ingest', 'stage_based_catfim_action_intervals_job_num', 'geom', 3857);