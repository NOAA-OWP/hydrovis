DROP TABLE IF EXISTS ingest.stage_based_catfim_action;
SELECT
    crosswalk.hand_id,
    crosswalk.hydro_id,
    crosswalk.feature_id,
    ROUND(CAST(rf.adj_action_stage_m * 35.315 as numeric), 2) AS forecast_stage_ft,
...
INTO ingest.stage_based_catfim_action
...
SELECT UpdateGeometrySRID('ingest', 'stage_based_catfim_action', 'geom', 3857);