DROP TABLE IF EXISTS cache.mrf_gfs_max_flows_alaska_para;
...
INTO cache.mrf_gfs_max_flows_alaska_para
FROM ingest.nwm_channel_rt_mrf_gfs_alaska_para forecasts
