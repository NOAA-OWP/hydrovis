DROP TABLE IF EXISTS cache.mrf_nbm_max_flows_alaska_para;
...
INTO cache.mrf_nbm_max_flows_alaska_para
FROM ingest.nwm_channel_rt_mrf_nbm_alaska_para forecasts
