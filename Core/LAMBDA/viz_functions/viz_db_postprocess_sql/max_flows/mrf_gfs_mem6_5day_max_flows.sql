CREATE TABLE IF NOT EXISTS cache.max_flows_mrf_gfs_mem6_5day
(
    feature_id bigint,
    reference_time text,
...
TRUNCATE TABLE cache.max_flows_mrf_gfs_mem6_5day;
INSERT INTO cache.max_flows_mrf_gfs_mem6_5day(feature_id, reference_time, nwm_vers, discharge_cms, discharge_cfs)
    ...
    FROM ingest.nwm_channel_rt_mrf_gfs_mem6 forecasts
