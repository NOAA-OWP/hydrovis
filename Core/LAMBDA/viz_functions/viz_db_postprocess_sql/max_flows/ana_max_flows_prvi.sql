CREATE TABLE IF NOT EXISTS cache.max_flows_ana_prvi
(
    feature_id bigint,
    reference_time text,
...
TRUNCATE TABLE cache.max_flows_ana_prvi;

INSERT INTO cache.max_flows_ana_prvi(feature_id, reference_time, nwm_vers, discharge_cms, discharge_cfs)
