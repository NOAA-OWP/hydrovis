DROP TABLE IF EXISTS publish.mrf_nbm_peak_flow_arrival_time;
...
JOIN publish.mrf_nbm_high_water_arrival_time as arrival_time ON forecasts.feature_id = arrival_time.feature_id and forecasts.reference_time = arrival_time.reference_time
