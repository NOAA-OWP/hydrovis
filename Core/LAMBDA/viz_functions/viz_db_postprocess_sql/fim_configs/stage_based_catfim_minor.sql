DROP TABLE IF EXISTS publish.stage_based_catfim_minor;
...
SELECT DISTINCT
	...
	station.rfc,
	station.state,
	'minor' as stage_category

INTO publish.stage_based_catfim_minor
FROM ingest.stage_based_catfim_minor AS inun
