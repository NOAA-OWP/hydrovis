DROP TABLE IF EXISTS publish.flow_based_catfim_moderate;
...
SELECT DISTINCT
	...
	station.rfc,
	station.state,
	flow.moderate_source as rating_source,
	'moderate' as flow_category

INTO publish.flow_based_catfim_moderate
FROM ingest.flow_based_catfim_moderate AS inun 
