DROP TABLE IF EXISTS publish.srf_48hr_max_inundation_extent_prvi;
...
SELECT  
    ...
    channels.name,
	'PRVI' AS state
INTO publish.srf_48hr_max_inundation_extent_prvi
FROM ingest.srf_48hr_max_inundation_extent_prvi as inun 
