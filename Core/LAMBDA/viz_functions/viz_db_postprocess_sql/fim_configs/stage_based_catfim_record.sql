DROP TABLE IF EXISTS publish.stage_based_catfim_record;
...
SELECT DISTINCT
	...
	station.rfc,
	station.state,
	'record' as stage_category

INTO publish.stage_based_catfim_record
FROM ingest.stage_based_catfim_record AS inun
