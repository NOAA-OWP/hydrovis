DROP TABLE IF EXISTS publish.flow_based_catfim_record;
...
SELECT DISTINCT
	...
	station.rfc,
	station.state,
	flow.record_source as rating_source,
	'record' as flow_category

INTO publish.flow_based_catfim_record
FROM ingest.flow_based_catfim_record AS inun 
