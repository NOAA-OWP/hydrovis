DROP TABLE IF EXISTS publish.mrf_nbm_max_high_flow_magnitude_para;
WITH high_flow_mag AS (
     SELECT maxflows.feature_id,
       ...
       FROM cache.mrf_nbm_max_flows_para maxflows
...
SELECT channels.feature_id,
    ...
    channels.geom
INTO publish.mrf_nbm_max_high_flow_magnitude_para
