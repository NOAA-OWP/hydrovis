...
INTO publish.srf_48hr_max_inundation_building_footprints_prvi
FROM external.building_footprints_fema as buildings
JOIN fim_ingest.srf_48hr_max_inundation_prvi_geo fim_geo ON ST_INTERSECTS(fim_geo.geom, buildings.geom)
JOIN fim_ingest.srf_48hr_max_inundation_prvi_flows flows ON fim_geo.hand_id = flows.hand_id
JOIN fim_ingest.srf_48hr_max_inundation_prvi fim ON fim_geo.hand_id = fim.hand_id;

--------------- County Summary ---------------
DROP TABLE IF EXISTS publish.srf_48hr_max_inundation_counties_prvi;
SELECT
	counties.geoid,
	...
	counties.geom
INTO publish.srf_48hr_max_inundation_counties_prvi
