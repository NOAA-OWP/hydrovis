...
DROP TABLE IF EXISTS PUBLISH.mrf_rapid_onset_flooding_hucs;
SELECT
	hucs.huc8,
	...
	hucs.geom
INTO publish.mrf_rapid_onset_flooding_hucs
FROM derived.huc8s_conus AS hucs
JOIN derived.featureid_huc_crosswalk AS crosswalk ON hucs.huc8 = crosswalk.huc8
JOIN publish.mrf_rapid_onset_flooding AS rof ON crosswalk.feature_id = rof.feature_id
