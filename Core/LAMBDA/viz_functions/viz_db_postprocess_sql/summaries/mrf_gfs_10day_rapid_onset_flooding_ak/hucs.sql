...
DROP TABLE IF EXISTS publish.mrf_gfs_10day_rapid_onset_flooding_hucs_alaska;
SELECT
	hucs.huc10,
	...
	hucs.geom
INTO publish.mrf_gfs_10day_rapid_onset_flooding_hucs_alaska
FROM derived.huc10s_alaska AS hucs
JOIN derived.featureid_huc_crosswalk_ak AS crosswalk ON hucs.huc10 = crosswalk.huc10
JOIN publish.mrf_gfs_10day_rapid_onset_flooding_alaska AS rof ON crosswalk.feature_id = rof.feature_id
