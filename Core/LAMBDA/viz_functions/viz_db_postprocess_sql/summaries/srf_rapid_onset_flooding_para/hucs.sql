...
DROP TABLE IF EXISTS publish.srf_rapid_onset_flooding_hucs_para;
SELECT
	hucs.huc10,
	...
	hucs.geom
INTO publish.srf_rapid_onset_flooding_hucs_para
FROM derived.huc10s_conus AS hucs
JOIN derived.featureid_huc_crosswalk AS crosswalk ON hucs.huc10 = crosswalk.huc10
JOIN publish.srf_rapid_onset_flooding_para AS rof ON crosswalk.feature_id = rof.feature_id
