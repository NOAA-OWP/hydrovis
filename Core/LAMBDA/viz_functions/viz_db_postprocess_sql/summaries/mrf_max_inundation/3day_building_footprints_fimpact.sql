...
CREATE INDEX IF NOT EXISTS mrf_max_inundation_3day_geom_idx ON publish.mrf_max_inundation_3day USING GIST (geom);

--------------- Building Footprints ---------------
DROP TABLE IF EXISTS publish.mrf_max_inundation_3day_building_footprints;
SELECT
	buildings.build_id,
    buildings.occ_cls,
    buildings.prim_occ,
