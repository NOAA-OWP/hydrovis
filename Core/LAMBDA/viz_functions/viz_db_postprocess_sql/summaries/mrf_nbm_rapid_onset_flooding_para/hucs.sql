...
DROP TABLE IF EXISTS publish.mrf_nbm_rapid_onset_flooding_hucs_para;
SELECT
	hucs.huc8,
	...
	hucs.geom
INTO publish.mrf_nbm_rapid_onset_flooding_hucs_para
FROM derived.huc8s_conus AS hucs
JOIN derived.featureid_huc_crosswalk AS crosswalk ON hucs.huc8 = crosswalk.huc8
JOIN publish.mrf_nbm_rapid_onset_flooding_para AS rof ON crosswalk.feature_id = rof.feature_id
