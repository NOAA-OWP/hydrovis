...
class MrfRapidOnsetFloodingProbability(AWSEgisPublishingProcess):
    service_name = 'mrf_gfs_rapid_onset_flooding_probability'
    ...
    def _process(self, a_event_time, a_input_files, a_output_location, *args, **kwargs):
        ...
        sql_files = [
            os.path.join(os.path.dirname(__file__), "mrf_gfs_rapid_onset_flooding_probability.sql"),
            os.path.join(os.path.dirname(__file__), "mrf_gfs_rapid_onset_flooding_probability_hucs.sql")
        ]

        service_table_names = ["mrf_gfs_rapid_onset_flooding_probability", "mrf_gfs_rapid_onset_flooding_probability_hucs"]
