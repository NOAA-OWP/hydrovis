...
class MrfHighWaterProbabilityForecast(AWSEgisPublishingProcess):
    service_name = 'mrf_gfs_high_water_probability_para'
    ...
    def _process(self, a_event_time, a_input_files, a_output_location, *args, **kwargs):
        ...
        sql_files = [
            os.path.join(os.path.dirname(__file__), "mrf_gfs_high_water_probability_para.sql"),
            os.path.join(os.path.dirname(__file__), "mrf_gfs_high_water_probability_hucs_para.sql")
        ]

        service_table_names = ["mrf_gfs_high_water_probability_para", "mrf_gfs_high_water_probability_hucs_para"]
