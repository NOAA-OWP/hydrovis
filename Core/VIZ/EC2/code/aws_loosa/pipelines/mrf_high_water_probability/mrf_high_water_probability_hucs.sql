DROP TABLE IF EXISTS publish.mrf_high_water_probability_hucs;
SELECT
	hucs.huc8,
	...
	hucs.geom
INTO publish.mrf_high_water_probability_hucs
FROM derived.huc8s_conus AS hucs
JOIN derived.featureid_huc_crosswalk AS crosswalk ON hucs.huc8 = crosswalk.huc8
JOIN publish.mrf_high_water_probability AS bp ON crosswalk.feature_id = bp.feature_id
