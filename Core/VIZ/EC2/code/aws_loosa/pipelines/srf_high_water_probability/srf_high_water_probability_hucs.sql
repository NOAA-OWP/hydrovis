DROP TABLE IF EXISTS publish.srf_high_water_probability_hucs;
SELECT
	hucs.huc10,
	...
	hucs.geom
INTO publish.srf_high_water_probability_hucs
FROM derived.huc10s_conus AS hucs
JOIN derived.featureid_huc_crosswalk AS crosswalk ON hucs.huc10 = crosswalk.huc10
JOIN publish.srf_high_water_probability AS bp ON crosswalk.feature_id = bp.feature_id
