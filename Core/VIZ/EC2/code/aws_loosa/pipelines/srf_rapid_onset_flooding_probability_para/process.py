...
class SrfRapidOnsetFloodingProbability(AWSEgisPublishingProcess):
    service_name = 'srf_rapid_onset_flooding_probability_para'
    ...
    def _process(self, a_event_time, a_input_files, a_output_location, *args, **kwargs):
        ...
        sql_files = [
            os.path.join(os.path.dirname(__file__), "srf_rapid_onset_flooding_probability_para.sql"),
            os.path.join(os.path.dirname(__file__), "srf_rapid_onset_flooding_probability_hucs_para.sql")
        ]

        service_table_names = ["srf_rapid_onset_flooding_probability_para", "srf_rapid_onset_flooding_probability_hucs_para"]
