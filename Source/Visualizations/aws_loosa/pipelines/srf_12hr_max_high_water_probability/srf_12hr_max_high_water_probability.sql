...
JOIN cache.srf_12hr_max_high_water_probability AS bp ON channels.feature_id = bp.feature_id;
DROP TABLE IF EXISTS cache.srf_12hr_max_high_water_probability;