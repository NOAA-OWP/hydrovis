...
JOIN cache.mrf_gfs_5day_rapid_onset_flooding_probability AS rofp ON channels.feature_id = rofp.feature_id;
DROP TABLE IF EXISTS cache.mrf_gfs_5day_rapid_onset_flooding_probability;