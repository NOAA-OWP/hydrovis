-- STOP - This is outdated and should not be used!! We've replaced this workflow with dumping / restoring specific database schemas, which preserves all this structure.
-- This script can be used as a reference for how the db was initially setup, but it is surely out of date at this point.
